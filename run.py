...
def get_sales_data():
    ...
    Run a while loop to collect a valid string 
    of data from the user via the termminal, which 
    must be a string of 6 numbers separeted by 
    comas. The loop will repeatedly request data, 
    until it is valid. 
    """
...
def validate_data(values):
    """
    Inside the try, converts all string values into integeres.
...
def get_last_5_entries_sales():
    ...
    collecting the last 5 entries for each sandwich and returns the data as a list of lists.
    """
